...
namespace FinalSis457Mmv.Controllers
{
    ...
    public class SeriesController : Controller
    {
        ...
        public SeriesController(FinalSis457MmvContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Series.Where(x => x.RegistroActivo == true).ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSis457MmvContext.Series'  is null.");
            }
            var series = await _context.Series.FindAsync(id);
            if (series != null)
            {
                series.RegistroActivo = false;
            }
